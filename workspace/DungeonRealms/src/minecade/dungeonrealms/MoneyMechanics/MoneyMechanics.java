...
public class MoneyMechanics implements Listener {
	...
	public static ItemStack t5_gem_pouch = ItemMechanics.signCustomItem(Material.INK_SACK, (short) 0, ChatColor.YELLOW.toString() + "Legendary Gem Jar" + ChatColor.GREEN + ChatColor.BOLD.toString() + " 0g", ChatColor.GRAY.toString() + "A giant container that holds " + ChatColor.BOLD + "1000g");
	...
	public int getMaxPouchCapacity(ItemStack is) {
		...
		if(i_name.contains("legendary")) { return 1000; }
		return 0;
	}
